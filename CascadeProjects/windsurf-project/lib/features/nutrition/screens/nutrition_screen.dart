...
class _NutritionScreenState extends State<NutritionScreen>
  ...
  void _loadData() async {
    ...
    if (authProvider.user != null) {
      await Future.wait([
        nutritionProvider.loadTodayNutrition(authProvider.user!.uid),
        nutritionProvider.loadTodayWaterIntake(authProvider.user!.uid),
      ]);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Consumer2<AuthProvider, NutritionProvider>(
      builder: (context, authProvider, nutritionProvider, child) {
        ...
        // todayNutrition may be null briefly; show zeros in that case
        final effectiveNutrition = todayNutrition ??
            NutritionEntry(
          ...
          child: Column(
            ...
            children: [
              ...
              NutritionProgressCard(
                title: 'Calories',
                current: effectiveNutrition.calories.toDouble(),
              ...
              NutritionProgressCard(
                title: 'Protein',
                current: effectiveNutrition.protein,
          ...
          child: Column(
            children: [
              ...
              WaterTracker(
                ...
                target: userModel.waterTarget,
                onAddWater: (amount) {
                  nutritionProvider.addWaterIntake(authProvider.user!.uid, amount);
                },
              ),
          ...
          return const Padding(
            ...
            child: Center(
              child: Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Icon(Icons.restaurant, color: AppTheme.grey, size: 48),
                  SizedBox(height: 16),
                  Text(
                    'No meals recorded',
        ...
        return Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: todayNutrition.meals.isEmpty
                    ? Center(
                        child: Column(
                          mainAxisAlignment: MainAxisAlignment.center,
                          children: [
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return MealCard(
                            ...
                            onDelete: () {
                              final authProvider = Provider.of<AuthProvider>(context, listen: false);
                              nutritionProvider.deleteMeal(authProvider.user!.uid, meal);
                            },
                          );
                        },
                      ),

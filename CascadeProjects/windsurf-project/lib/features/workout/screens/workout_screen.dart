  ...
  void _loadData() async {
    ...
    if (authProvider.user != null) {
      await Future.wait([
        ...
        workoutProvider.loadUserWorkouts(authProvider.user!.uid),
        workoutProvider.loadWorkoutPlan(authProvider.user!.uid),
      ]);
    }
  }
  ...
  Widget build(BuildContext context) {
    return Consumer<WorkoutProvider>(
      builder: (context, workoutProvider, child) {
        final todayWorkout =
            workoutProvider.workoutPlan?.weeklyPlan[DateTime.now().weekday];
